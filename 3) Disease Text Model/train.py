...
class CropDiseaseTabNet:
    ...
    def load_and_prepare_data(self, csv_file):
        ...
        self.feature_columns = [col for col in df.columns if col != 'disease']
    ...
    def evaluate_model(self, X_test, y_test):
        ...
        plt.show()
        return accuracy
    def save_model(self, model_path='tabnet_crop_disease_model'):
    ...
    def predict_disease(self, farmer_responses):
        ...
        return disease_name, confidence, probabilities[0]
tabnet_model = CropDiseaseTabNet()
X_train, X_val, X_test, y_train, y_val, y_test = tabnet_model.load_and_prepare_data('data.csv')
tabnet_model.train_model(X_train, y_train, X_val, y_val)
accuracy = tabnet_model.evaluate_model(X_test, y_test)
tabnet_model.save_model('crop_disease_tabnet')
